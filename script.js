// ==========================
// 🌐 CONTADOR REAL (ROBUSTO)
// ==========================
const counterEl = document.getElementById("visit-count");

const namespace = "tomas-andrada-" + location.hostname;
...
musicBtn.addEventListener("click", function () {
  ...
  if (!isPlaying) {
    ...
    // ⚠️ ejecución directa (clave mobile)
    music.currentTime = 0;
    music.play();
